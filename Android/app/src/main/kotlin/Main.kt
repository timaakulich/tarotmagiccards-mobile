...
internal val logger: SkipLogger = SkipLogger(subsystem = "tarot.magic.cards", category = "TarotMagicCards")

private typealias AppRootView = TarotMagicCardsRootView
private typealias AppDelegate = TarotMagicCardsAppDelegate
